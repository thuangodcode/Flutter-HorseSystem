  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        "data-[size=sm]:h-7 data-[size=sm]:rounded-md data-[size=sm]:px-2 data-[size=sm]:text-xs",
    ...
    <SelectPrimitive.Portal>
      ...
      >
        <SelectPrimitive.Popup
          ...
          className={cn(
            "relative z-[9999] isolate",
            "max-h-(--available-height) min-w-36 overflow-x-hidden overflow-y-auto",
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "relative flex w-full cursor-pointer items-center gap-2 rounded-md py-2 pr-8 pl-2 text-sm font-semibold outline-none select-none",
